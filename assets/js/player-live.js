/**
 * [video鎾斁]
 * Created by wxs on 2017/6/21.
 * fix by xu.qiang on 2017/10/12.
 */
;(function(window,undefined){
    /**
      ** 鎾斁鍣� 鍚勭姸鎬� 鍙互鍦ㄨ繖閲屾崟鑾峰埌鐩稿簲鐘舵€佸悗 澶勭悊涓氬姟閫昏緫銆�
    **/
    ...
    XcarPlayer.defOptions={
        src:'0',
        movie:'http://js.xcar.com.cn/source/xbb/ArcMediaPlayback.swf',
        quality:'high',
        wmode:"transparent",
    ...
    XcarPlayer.flashVarsProps=['width','height','autoPlay','shareDisplay','logoDisplay','src'];
    ...
    Player.prototype={
        ...
        iePlayer:function(settings,flashVars){
            var html=[];
            html.push('<object id="'+this.uid+'" name="'+this.uid+'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="'+this.width+'" height="'+this.height+'" style="display:block;background: rgb(0, 0, 0)">');
